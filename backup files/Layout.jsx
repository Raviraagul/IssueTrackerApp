        ...
        <>
            ...
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
                ...
                <aside className="hidden lg:flex flex-col w-60 bg-white dark:bg-gray-800
                         border-r border-gray-200 dark:border-gray-700 fixed 
                ...
                {sidebarOpen && (
                    <div className="lg:hidden fixed inset-0 z-40 flex">
                        <div
                            ...
                            onClick={() => setSidebarOpen(false)}
                        />
                        <aside className="relative flex flex-col w-64 bg-white dark:bg-gray-800
                             shadow-xl z-50">
                            <button
                                onClick={() => setSidebarOpen(false)}
                        ...
                        <div className="flex items-center gap-2">
                         ...
                         dark:text-gray-400 dark:hover:bg-gray-700 transition-colors"
                           ...
                           dark:hover:bg-gray-700 transition-colors"
                                ...
                                dark:border-gray-700 py-1 z-50">
